...
3	OTP returned in API response (Auth.js:195)	Attacker can extract OTP without email access
...
Rich Text Editor	Replace textarea with TipTap/BlockNote — headings, bold, code blocks, embeds, markdown
