...
const Explore = () => {
   return (
      <div className='min-h-screen flex gap-4 px-2 mt-2 accent-text-mode'>
         <div className='w-[35%] h-screen overflow-y-auto shadow-accent-box p-3 rounded-2xl bg-card-mode'>
            <h1 className='text-xl font-bold  accent-text mb-4'>🔥 <span className='accent-underline'>Trending Posts on Bloggr</span></h1>
            <Trending />
         </div>

         <div className='w-[53%] h-screen overflow-y-auto shadow-accent-box p-2 rounded-2xl bg-card-mode'>
            <h1 className='text-xl font-bold accent-text mb-4'>🌍 <span className='accent-underline'>Blogs Around the World</span></h1>
            <ArroundTheWorld />
         </div>

         <div className='w-[10%] h-screen overflow-y-auto  overflow-x-hidden shadow-accent-box p-3 rounded-2xl bg-card-mode'>
